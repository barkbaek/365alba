$(document).ready(function() {
    var id = window.location.pathname.replace("/edit-albareview/", "");
    ...
    var submit = function (e) {
        ...
        methods["the_world"]["is_one"]({
            show_animation: true,
            data: data,
            pathname:"/edit-albareview",
            s_cb:s_cb,
            f_cb:f_cb
        });
    };
    $(document).on("submit", "#edit-albareview-form", function(e) {
        submit(e);
        return false;
    });
    $(document).on("click", "#edit-albareview-submit", function(e) {
        submit(e);
        return false;
    });
});