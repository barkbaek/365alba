$(document).ready(function() {
    var id = window.location.pathname.replace("/edit-albaboard/", "");
    ...
    var submit = function (e) {
        ...
        methods["the_world"]["is_one"]({
            show_animation: true,
            data: data,
            pathname:"/edit-albaboard",
            s_cb:s_cb,
            f_cb:f_cb
        });
    };
    $(document).on("submit", "#edit-albaboard-form", function(e) {
        submit(e);
        return false;
    });
    $(document).on("click", "#edit-albaboard-submit", function(e) {
        submit(e);
        return false;
    });
});