    ...
    var submit = function (e) {
        ...
        var s_cb = function (result) {
            if ( result['response'] === true ) {
                ...
                } else if (result.msg === "no_company") {
                    return show_bert("danger", 2000, "기업서비스 로그인 후 다시 시도해주세요.");
                } else {
                    return show_bert("danger", 2000, "서버 내부 오류가 발생하였습니다. 잠시 후 다시 시도해주세요.");
                }
            }
        ...
        methods["the_world"]["is_one"]({
            show_animation: true,
            data: data,
            pathname:"/create-ceoboard",
            s_cb:s_cb,
            f_cb:f_cb
        });
    };
    $(document).on("submit", "#create-ceoboard-form", function(e) {
        submit(e);
        return false;
    });
    $(document).on("click", "#create-ceoboard-submit", function(e) {
        submit(e);
        return false;
    });
});
